...
const Cardtool = ({ icon }) => {
    ...
    let date = ()=> {
        ...
        let x = new Date().toLocaleTimeString('en-US');
        setTime(x);
      }
    ...
    return (
        <>
            <Box className=" flex w-[300px] h-[85px] rounded-[20px] justify-around bg-white mt-8 shadow-[0_0.6em_1.2em_rgba(28,0,80,0.06)] "  >
                <Box>
                    <h1 className="text-[20px] text-[gray] relative top-3  ml-10 " > Time </h1>
                    <h1 className="text-[20px] font-[800] text-[black] relative top-3  ml-10 " >{Time}</h1>
